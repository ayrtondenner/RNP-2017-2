...
tf.flags.DEFINE_string("logs_dir", "logs/DeepBuilding_WGAN_logs/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "D:/DeepBuilding/input/", "path to dataset")
...
tf.flags.DEFINE_string("image_size", "128,64", "Size of actual images, Size of images to be generated at.")
...
def main(argv=None):
    ...
    generator_dims = [64 * gen_dim, 64 * gen_dim // 2, 64 * gen_dim // 4, 64 * gen_dim // 8, 1]
